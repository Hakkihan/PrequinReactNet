...
DB Scaffold command:
dotnet ef dbcontext scaffold "Host=localhost;Port=5432;Database=Prequin;Username=postgres;Password=1E2l3l4a" Npgsql.EntityFrameworkCore.PostgreSQL -o Models --context PGSQLDbContext
